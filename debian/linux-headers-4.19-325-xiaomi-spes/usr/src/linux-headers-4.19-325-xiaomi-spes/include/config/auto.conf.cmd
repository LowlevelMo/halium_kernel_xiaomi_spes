...
ifneq "$(CC_VERSION_TEXT)" "Android (8490178, based on r450784d) clang version 14.0.6 (https://android.googlesource.com/toolchain/llvm-project 4c603efb0cca074e9238af8b4106c30add4418f6)"
include/config/auto.conf: FORCE
endif
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-android --prefix=/usr/bin/aarch64-linux-android- --gcc-toolchain=/usr  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
